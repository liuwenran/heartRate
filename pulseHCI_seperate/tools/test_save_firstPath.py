...
if __name__ == '__main__':
    ...
    pretrained_model = '../data/output_face_test/ex3_HCI_seperate_iter_60000.caffemodel'
    ...
    np.save('../data/output/HCI_result_seperate6w.npy', result)
    np.save('../data/output/HCI_label_seperate6w.npy', originLabel)
    np.save('../data/output/HCI_firstPath_seperate6w.npy', firstPath)
