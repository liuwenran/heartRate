...
class SolverWrapper(object):
    ...
    def train_model(self, max_iters):
        ...
        while self.solver.iter < max_iters:
            ...
            sigScoreData = net.blobs['sigScore'].data
            gtlabelData = net.blobs['label'].data
            print 'sigScore is ' + str(sigScoreData[0][0]) + ' gtlabel is ' + str(gtlabelData[0])
...
if __name__ == '__main__':
    datafile = '/net/liuwenran/datasets/HCI/experiment/ex3_cnn_face/finalExData_shuffled/train_float_seperate.h5'
    face_rootPath = '/net/liuwenran/datasets/HCI/experiment/videoFrame/RoughFace/'
    ...
    # pretrained_model = '../data/output_face_test/ex3_HCI_loadppretrain_iter_30000.caffemodel'
