...
if __name__ == '__main__':
    ...
    np.save('../data/output/HCI_result_later3w_savefirst.npy', result)
    np.save('../data/output/HCI_label_later3w_savefirst.npy', originLabel)
    np.save('../data/output/HCI_firstPath_later3w_savefirst.npy', firstPath)
