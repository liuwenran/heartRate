...
result = np.load('output/HCI_result_later3w_forseperate.npy')
originLabel = np.load('output/HCI_label_later3w_forseperate.npy')
firstPath = np.load('output/HCI_firstPath_later3w_forseperate.npy')
