...
if __name__ == '__main__':
    ...
    test_prototxt = '/net/liuwenran/heartRate/pulseEx3_sharedPre/proto/ex3_test_loadconv.prototxt'
    rootPath = '/net/liuwenran/datasets/DEAP/experiment/ex2_fc_face/RoughFace/'
    pretrained_model = '/net/liuwenran/heartRate/pulseEx3_sharedPre/data/output_face_test/ex3_loadconv_Euc_iter_10000.caffemodel'
    ...
    np.save('../data/output/test_result_1w.npy', result)
    np.save('../data/output/test_label_1w.npy', originLabel)
