...
if __name__ == '__main__':
    datafile = '/net/liuwenran/datasets/DEAP/experiment/ex3_cnn_face/finalExData_shuffled/test_float_notperm.h5'
    test_prototxt = '../proto/ex3_test_loadconv.prototxt'
    rootPath = '/net/liuwenran/datasets/DEAP/experiment/ex2_fc_face/RoughFace/'
    pretrained_model = '/net/liuwenran/heartRate/pulseEx3_sharedPre/data/output_face_test/ex3_load_pretrain_iter_60000.caffemodel'
    ...
    np.save('../data/output/result_load_pretrain6w_forseperate.npy', result)
    np.save('../data/output/label_load_pretrain6w_forseperate.npy', originLabel)
    np.save('../data/output/firstPath_load_pretrain6w_forseperate.npy', firstPath)
