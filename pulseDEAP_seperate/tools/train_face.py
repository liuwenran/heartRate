...
if __name__ == '__main__':
    datafile = '/net/liuwenran/datasets/DEAP/experiment/ex3_cnn_face/finalExData_shuffled/train_float_notperm.h5'
   ...
   # pretrained_model = '/net/liuwenran/fast-rcnn/data/fast_rcnn_models/caffenet_fast_rcnn_iter_40000.caffemodel'
    pretrained_model = '../data/output_face_test/ex3_seperate_iter_10000.caffemodel'
    # pretrained_model = None 
