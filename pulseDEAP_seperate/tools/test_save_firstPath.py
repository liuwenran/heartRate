...
if __name__ == '__main__':
    ...
    pretrained_model = '../data/output_face_test/ex3_seperate_iter_60000.caffemodel'
    ...
    np.save('../data/output/result_deap_seperate6w_savefirst.npy', result)
    np.save('../data/output/label_deap_seperate6w_savefirst.npy', originLabel)
    np.save('../data/output/firstPath_deap_seperate6w_savefirst.npy', firstPath)
