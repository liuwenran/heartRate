...
class faceDataLayer(caffe.Layer):
    ...
    def _get_next_minibatch(self):
        ...
        if cfg.TRAIN.USE_PREFETCH:
            ...
            tempFirstPath = self._slots_firstPath.get()
            blob = {}
    ...
    def setup_prefetch(self):
        ...
        self._slots_firstPath = Queue(self._max_queue_size)
        ...
        for i in range(self._processNum):
            ...
            self._prefetch_process[i] = BlobFetcher(i, self._prefetch_process_id_q, self._slots_used, self._slots_filled, 
                                             self._slots_firstPath, partdata, self._shared_mem_shape, self._num_tops)
    ...
    def forward(self, bottom, top):
        ...
        blobs, tempFirstPath = self._get_next_minibatch()

        self.now_firstPath = tempFirstPath
...
class BlobFetcher(Process):
    ...
    def __init__(self, selfid, process_pid_q, slots_used, slots_filled, slots_firstPath, partdata, shared_mem_shape, num_tops):
        super(BlobFetcher, self).__init__()
        self._id = selfid
        self._prefetch_process_id_q = process_pid_q;
        self._slots_used = slots_used
        self._slots_filled = slots_filled
        self._slots_firstPath = slots_firstPath
        self._data = partdata
    ...
    def run(self):
        ...
        while True:
            ...
            temp = {'firstPath':firstPath, 'label': label}
            self._slots_firstPath.put(temp)
